        ...
        <div className="flex h-[calc(100%-80px)]">
          <div className="w-20 flex flex-col items-center py-6 gap-4 border-r border-white/10 overflow-visible">
            ...
            <button 
              ...
              className={`w-12 h-12 rounded-xl flex items-center justify-center text-white transition-all group relative overflow-visible ${
                activeView === 'ai-diagnosis' ? 'bg-gradient-to-br from-red-400 to-red-600' : 'bg-white/10 hover:bg-white/20'
              }`}
            >
              <svg className="w-6 h-6 relative z-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex-1 p-8 overflow-y-auto">
                    ...
                    <div className="grid grid-cols-7 gap-2">
                      {dates.flat().map((date, idx) => (
                        <div
                          ...
                          className={`h-9 flex items-center justify-center rounded-lg text-xs transition-all cursor-pointer
                            ${!date ? 'invisible' : ''}
                            ${date === selectedDate 
            ...
            {activeView === 'ai-diagnosis' && (
              <div>
                <div className="mb-6">
                  <h2 className="text-2xl font-bold text-white mb-1">AI Diagnosis</h2>
                  <p className="text-gray-400 text-sm">Analyze patient data with AI-powered predictions</p>
                </div>
                <AIDiagnosis />
              </div>
            )}
